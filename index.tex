...
\begin{tcolorbox}[enhanced jigsaw, colback=white, coltitle=black, bottomrule=.15mm, rightrule=.15mm, toptitle=1mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, breakable, opacityback=0, left=2mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Tip: De Morgan Laws}, arc=.35mm, toprule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, colframe=quarto-callout-important-color-frame, colback=white, breakable, opacityback=0, left=2mm, bottomrule=.15mm, arc=.35mm, rightrule=.15mm, toprule=.15mm]
\begin{minipage}[t]{5.5mm}
...
\begin{tcolorbox}[enhanced jigsaw, colback=white, coltitle=black, bottomrule=.15mm, rightrule=.15mm, toptitle=1mm, leftrule=.75mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, breakable, opacityback=0, left=2mm, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Tip: A useful inequality}, arc=.35mm, toprule=.15mm]
