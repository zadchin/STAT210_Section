...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-tip-color-frame, toprule=.15mm, leftrule=.75mm, left=2mm, colback=white, breakable, rightrule=.15mm, bottomrule=.15mm, arc=.35mm, opacityback=0]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, bottomtitle=1mm, colback=white, breakable, toptitle=1mm, bottomrule=.15mm, opacityback=0, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, titlerule=0mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Tip: De Morgan Laws}, toprule=.15mm, arc=.35mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-important-color-frame, toprule=.15mm, leftrule=.75mm, left=2mm, colback=white, breakable, rightrule=.15mm, bottomrule=.15mm, arc=.35mm, opacityback=0]
\begin{minipage}[t]{5.5mm}
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, bottomtitle=1mm, colback=white, breakable, toptitle=1mm, bottomrule=.15mm, opacityback=0, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, titlerule=0mm, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Tip: A useful inequality}, toprule=.15mm, arc=.35mm, left=2mm]
