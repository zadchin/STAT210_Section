...
\begin{tcolorbox}[enhanced jigsaw, breakable, rightrule=.15mm, colback=white, arc=.35mm, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, opacityback=0, toprule=.15mm, left=2mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, colback=white, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, toprule=.15mm, leftrule=.75mm, rightrule=.15mm, opacityback=0, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Tip: De Morgan Laws}, arc=.35mm, coltitle=black, bottomrule=.15mm, titlerule=0mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, rightrule=.15mm, colback=white, arc=.35mm, colframe=quarto-callout-important-color-frame, bottomrule=.15mm, opacityback=0, toprule=.15mm, left=2mm, leftrule=.75mm]
\begin{minipage}[t]{5.5mm}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, colback=white, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, toprule=.15mm, leftrule=.75mm, rightrule=.15mm, opacityback=0, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, toptitle=1mm, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Tip: A useful inequality}, arc=.35mm, coltitle=black, bottomrule=.15mm, titlerule=0mm]
