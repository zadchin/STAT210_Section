...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, opacityback=0, breakable, left=2mm, rightrule=.15mm, leftrule=.75mm, arc=.35mm, colback=white, bottomrule=.15mm, colframe=quarto-callout-tip-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, titlerule=0mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, leftrule=.75mm, bottomrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Tip: De Morgan Laws}, breakable, toptitle=1mm, left=2mm, arc=.35mm, colback=white, bottomtitle=1mm, colframe=quarto-callout-note-color-frame]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, opacityback=0, breakable, left=2mm, rightrule=.15mm, leftrule=.75mm, arc=.35mm, colback=white, bottomrule=.15mm, colframe=quarto-callout-important-color-frame]
\begin{minipage}[t]{5.5mm}
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, titlerule=0mm, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, leftrule=.75mm, bottomrule=.15mm, toprule=.15mm, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Tip: A useful inequality}, breakable, toptitle=1mm, left=2mm, arc=.35mm, colback=white, bottomtitle=1mm, colframe=quarto-callout-note-color-frame]
...
\(G^*\sim \text{Gamma} (n)\) and \(X \ci G^*\) (since \(U\)'s and
\(Z\)'s are independent).\textbackslash{}
...
\(G_{\frac{m}{2}} \ci G_{n-\frac{m}{2}}\) . This gives us the
following.\textbackslash{} \underline{Step-2:}
\(X \sim \text{Beta}(\frac{m}{2},n-\frac{m}{2})\)

Now, we know that
\(G_{\frac{m}{2}} + G_{n-\frac{m}{2}} \sim \text{Gamma}(n)\) and
\((G_{\frac{m}{2}} + G_{n-\frac{m}{2}}) \ci \frac{G_{\frac{m}{2}}}{ G_{\frac{m}{2}} + G_{n-\frac{m}{2}}}\).
...
\((Z_1 + Z_2)\ci (Z_1 - Z_2)\) (this is one of the many special
properties of the Normal distribution), we can jointly represent them as
\((Z_1 + Z_2, Z_1-Z_2) \sim (\sqrt{2} Z_1, \sqrt{2} Z_2)\).
