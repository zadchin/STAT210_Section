...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, colback=white, breakable, leftrule=.75mm, left=2mm, opacityback=0, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, bottomrule=.15mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, opacityback=0, colframe=quarto-callout-note-color-frame, coltitle=black, opacitybacktitle=0.6, bottomtitle=1mm, leftrule=.75mm, breakable, toptitle=1mm, titlerule=0mm, colback=white, arc=.35mm, rightrule=.15mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Tip: De Morgan Laws}]
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, colback=white, breakable, leftrule=.75mm, left=2mm, opacityback=0, colframe=quarto-callout-important-color-frame, rightrule=.15mm, bottomrule=.15mm, arc=.35mm]
\begin{minipage}[t]{5.5mm}
...
\begin{tcolorbox}[enhanced jigsaw, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, opacityback=0, colframe=quarto-callout-note-color-frame, coltitle=black, opacitybacktitle=0.6, bottomtitle=1mm, leftrule=.75mm, breakable, toptitle=1mm, titlerule=0mm, colback=white, arc=.35mm, rightrule=.15mm, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Tip: A useful inequality}]
