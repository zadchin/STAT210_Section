...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, sharp corners, enhanced, interior hidden, breakable, frame hidden, boxrule=0pt]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, bottomrule=.15mm, leftrule=.75mm, arc=.35mm, opacityback=0, colframe=quarto-callout-tip-color-frame, toprule=.15mm, rightrule=.15mm, breakable, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Tip: De Morgan Laws}, opacitybacktitle=0.6, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, rightrule=.15mm, breakable, colback=white, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, coltitle=black, opacityback=0, colframe=quarto-callout-note-color-frame, titlerule=0mm, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, bottomrule=.15mm, leftrule=.75mm, arc=.35mm, opacityback=0, colframe=quarto-callout-important-color-frame, toprule=.15mm, rightrule=.15mm, breakable, colback=white]
\begin{minipage}[t]{5.5mm}
...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Tip: A useful inequality}, opacitybacktitle=0.6, toprule=.15mm, bottomtitle=1mm, toptitle=1mm, rightrule=.15mm, breakable, colback=white, bottomrule=.15mm, colbacktitle=quarto-callout-note-color!10!white, leftrule=.75mm, coltitle=black, opacityback=0, colframe=quarto-callout-note-color-frame, titlerule=0mm, arc=.35mm]
